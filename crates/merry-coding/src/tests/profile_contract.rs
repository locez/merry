use crate::{
    CODING_AGENT_POLICY_PROMPT, CodingAgentRunPolicy, CodingFinalReportPolicy, ProjectRules,
    TaskAnchor, coding_agent,
    tests::{bridge_tool, bridge_tool_with_description, process_session},
};
