...
pub struct ToolExecutionContext {
    ...
    approved_apply_patch: Option<WorkspacePatchProposal>,
}
...
fn validate_apply_patch_changes(
...
fn validate_apply_patch_counts(
    preimage_bytes: usize,
    replacement_bytes: usize,
    file_bytes_before: usize,
    file_bytes_after: usize,
...
fn validate_apply_patch_fingerprint(
    field: &'static str,
    value: String,
...
fn validate_apply_patch_relative_path(value: String) -> Result<String, ActionProposalError> {
    if value.trim().is_empty() {
        return Err(ActionProposalError::InvalidWorkspacePatch {
            field: "relative_path",
            reason: "must not be blank",
