use crate::{
    judgment::{
        ...
        JudgmentRiskLevel, JudgmentSource, JudgmentSourceKind, ModelBackedJudgmentSource,
    },
    runtime::tests::support::{
        common::{artifact_id, model_name},
...
pub(in crate::runtime::tests) fn judgment_evidence(
    label: &str,
    id: &str,
...
pub(in crate::runtime::tests) fn judgment_constraints() -> Vec<String> {
    vec!["advisory semantic signal only".to_owned()]
}

pub(in crate::runtime::tests) fn judgment_confidence(value: f32) -> JudgmentConfidence {
    JudgmentConfidence::new(value).expect("valid judgment confidence")
}

pub(in crate::runtime::tests) fn judgment_provenance() -> JudgmentProvenance {
    JudgmentProvenance::new(JudgmentSourceKind::Test, "runtime scripted source")
        .expect("valid judgment provenance")
}

pub(in crate::runtime::tests) fn tool_risk_review_request(
...
pub(in crate::runtime::tests) fn high_tool_risk_outcome(
    evidence: Vec<JudgmentEvidence>,
) -> JudgmentOutcome {
    JudgmentOutcome::new(
        JudgmentPurpose::ToolRiskReview,
...
pub(in crate::runtime::tests) fn unknown_tool_risk_outcome(
    evidence: Vec<JudgmentEvidence>,
) -> JudgmentOutcome {
    JudgmentOutcome::new(
        JudgmentPurpose::ToolRiskReview,
...
pub(in crate::runtime::tests) fn model_backed_judgment_source(
...
pub(in crate::runtime::tests) fn model_tool_risk_judgment_json(
    risk: &str,
    concern: &str,
...
#[derive(Debug)]
pub(in crate::runtime::tests) enum ScriptedJudgmentResponse {
...
#[derive(Debug, Clone)]
pub(in crate::runtime::tests) struct ScriptedJudgmentSource {
    pub(in crate::runtime::tests) responses: Arc<StdMutex<Vec<ScriptedJudgmentResponse>>>,
    pub(in crate::runtime::tests) calls: Arc<AtomicUsize>,
}

impl ScriptedJudgmentSource {
    pub(in crate::runtime::tests) fn new(responses: Vec<ScriptedJudgmentResponse>) -> Self {
        Self {
    ...
    pub(in crate::runtime::tests) fn with_outcome(outcome: JudgmentOutcome) -> Self {
