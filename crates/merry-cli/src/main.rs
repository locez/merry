...
use merry_runtime::{AutomaticCompactionConfig, Runtime, RuntimeBuilder, StepContext, StepInput};
...
mod tests {
    use super::{
        ...
        DEFAULT_SESSION_ID, DebugCommand, SandboxChildHandoff, collect_runtime_step_events,
        debug_openai_usage, first_pending_tool_call, report_cli_exit, shell_usage,
    };
